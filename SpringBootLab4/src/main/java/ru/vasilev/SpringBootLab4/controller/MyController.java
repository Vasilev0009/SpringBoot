package ru.vasilev.SpringBootLab4.controller;
...
import ru.vasilev.SpringBootLab4.model.*;
import jakarta.validation.Valid;
import ru.vasilev.SpringBootLab4.service.ModifyResponseService;
import ru.vasilev.SpringBootLab4.service.ValidationService;
...
public class MyController {
    ...
    public ResponseEntity<Responce> feedback(@Valid @RequestBody Request request,
        ...
        log.info("Time original request: {}", request.getSystemTime());
        ...
        log.info("Time modified request: {}", responce.getSystemTime());
